...
// Copyright (c) 2019, The HITrust project
//
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 12275;
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(30000000000); //actual amount
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "013c01ff00018094ebdc03025a4bd658394ed1b653a9c678242bd8454fca3c37f57b6ce4e9ae5f598dff56ff2101781e6b1a2b64912dbc286f6403e123731a861acf0b1939dc6a6c2a2705d57cc8";
static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in TurtleCoind. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1547239641;
...
const char     CRYPTONOTE_NAME[]                             = "HITrust";
...
const int      P2P_DEFAULT_PORT                              =  11210;
const int      RPC_DEFAULT_PORT                              =  11211;
...
const char     LATEST_VERSION_URL[]                          = "https://github.com/HITHELPINSURANCETRUST/HIT/releases";
const std::string LICENSE_URL                                = "https://github.com/HITHELPINSURANCETRUST";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0x57 ,0x45, 0x4c ,0x43, 0x4f, 0x4d, 0x45, 0x48, 0x49, 0x54, 0x52 ,0x55, 0x53, 0x54, 0x49, 0x45  }
};

const char* const SEED_NODES[] = {
  "188.40.181.252:11210",//nox
  "159.69.217.206:11210", //gun
  "45.76.23.250:11210" //hon
};
} // CryptoNote
